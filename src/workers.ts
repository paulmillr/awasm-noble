...
- A worker, after registering a new module, does 'initWorker(notifyOnly=1)' on module to set "online"
  flag
...
- Pool worker sees local cmd, then calls 'workerProcess' which calls internal per module initWorker(doOnce=1);
*/
